...
DROP TABLE IF EXISTS user_knowledge_permission;
DROP TABLE IF EXISTS user_agent_permission;
DROP TABLE IF EXISTS agent_access_config;
DROP TABLE IF EXISTS knowledge_repository_task;
...
(
    ...
    creator_user_id          char(32)      DEFAULT NULL REFERENCES app_user (id) ON DELETE SET NULL,
...
DROP TABLE IF EXISTS object_file_reference;
DROP TABLE IF EXISTS object_storage_sync_diff;
DROP TABLE IF EXISTS object_storage_sync_task;
